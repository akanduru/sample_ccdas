...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:n3="http://www.w3.org/1999/xhtml" xmlns:n1="urn:hl7-org:v3" xmlns:n2="urn:hl7-org:v3/meta/voc" xmlns:voc="urn:hl7-org:v3/voc" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance">
  ...
  <!-- Internal Stylesheet -->
  <!--xsl:variable name="baseUri">\PrimePractice\Clinical\Stylesheets\stylesheets\</xsl:variable-->
  <!-- External Stylesheet -->
  <!--xsl:variable name="baseUri">http://nhind.greenwaymedical.com/XDServiceSite/</xsl:variable-->
  <!--xsl:variable name="baseUri">http://interopsvcdev01.greenwaymedical.com:8080/InteropServiceBus.ExternalWcfService/Stylesheets/</xsl:variable-->
    ...
    <html>
      <head>
        ...
        <title xml:space="preserve">
			<xsl:value-of select="$title"/> - <xsl:apply-templates select="n1:recordTarget/n1:patientRole/n1:patient/n1:name"/>
		</title>
        <style type="text/css">
          ...
          text-align: left;
          vertical-align: top;
          background-color: #E7E1D5; /* main body where clinical data lives*/
          border-color: #006633;
          ...
          vertical-align: top;
          color: #000000;
          background-color: #E7E1D5; /* header */
          ...
          /* patient detail section heading */
          th.third {
          text-align: left;
          vertical-align: top;
          color: black;
...
<table border="1" cellspacing="0" cellpadding="0" width="auto" class="first">
	<th class="first">
    <!-- this logo is only used in externally produced stylesheets -->
    <!--		<center><img src="{$baseUri}gw_corp_CG_RGB.gif" alt="Greenway Medical Technologies"/></center> -->
		<center style="padding-bottom:10px;"><nobr><xsl:value-of select="$title"/> - <xsl:apply-templates select="n1:recordTarget/n1:patientRole/n1:patient/n1:name"/></nobr></center>
	</th>
<!--Document Information -->
	<tr>
		<td>
			<table border="0" width="100%" cellspacing="0" cellpadding="0" class="second">
				<th class="second" colspan="2"><nobr><xsl:text>Document Information</xsl:text></nobr>
					<table>
						<tr>
				<td class="toc">
					<!--<div id="menu">
				...
				<tr>
					...
					<td width="50%" height="100%" valign="top">
						...
						<xsl:if test="n1:effectiveTime/@value!=''">
								<tr class="content">
									<td class="content">
										<b><nobr><xsl:text>Created On:</xsl:text></nobr></b>
									</td>
									<td class="content">
							...
							<xsl:if test="n1:documentationOf/n1:serviceEvent/n1:effectiveTime/n1:low/@value!=''">
								<tr class="content">
									<td class="content">
										<b><nobr><xsl:text>Visit Date:</xsl:text></nobr></b>
									</td>
									<td class="content">
										<xsl:apply-templates select="n1:documentationOf/n1:serviceEvent/n1:effectiveTime/n1:low" mode="Date"/>
									</td>
								</tr>
							</xsl:if>
              <xsl:for-each select="n1:telecom">
              ...
              <!-- Change made for CCDA, added Care Team section-->                      
							<xsl:if test="n1:documentationOf/n1:serviceEvent/n1:performer">
                  <tr class="content">
                    <td class="content">
										  <b><nobr><xsl:text>Care Team:</xsl:text></nobr></b>
									  </td>
									<td class="content">                    
                      <xsl:for-each select="n1:documentationOf/n1:serviceEvent/n1:performer">
							          <xsl:if test="n1:assignedEntity/n1:assignedPerson/n1:name/n1:given" >
...
<xsl:if test="n1:patient/n1:birthTime/@value!=''">
 ...
 <nobr>
  <xsl:apply-templates select="n1:patient/n1:birthTime" mode="Date" /> 
  </nobr>
  ...
  <tr class="content">
    ...
    <td width="100%" class="content">
      <xsl:apply-templates select="n1:patient/n1:administrativeGenderCode" mode="Gender" /> 
										...
										<xsl:if test="n1:patient/n1:raceCode/@code!=''"> <!-- Change made for CCDA, need to check for code for this to work -->
											<tr class="content">
												<td class="content">
													<b><xsl:text>Race:</xsl:text></b>
												</td>
										...
										<xsl:if test="n1:patient/n1:ethnicGroupCode/@code!=''"> <!-- Change made for CCDA, need to check for code for this to work -->
											<tr class="content">
												<td class="content">
										...
										<xsl:if test="n1:patient/n1:languageCommunication/n1:languageCode"> <!-- Change made for CCDA, test updated to check correct node -->
											<tr class="content">
												<td class="content">
												...
												<td width="100%" class="content">
                          <xsl:choose>
                            <xsl:when test="n1:patient/n1:languageCommunication/n1:languageCode[@code='en'] or n1:patient/n1:languageCommunication/n1:languageCode[@code='eng']">
                              <xsl:text>English</xsl:text>
                            </xsl:when>
                            <xsl:when test="n1:patient/n1:languageCommunication/n1:languageCode[@code='es'] or n1:patient/n1:languageCommunication/n1:languageCode[@code='spa']">
                              <xsl:text>Spanish</xsl:text>
                            </xsl:when>
                            <xsl:when test="n1:patient/n1:languageCommunication/n1:languageCode[@code='fr'] or n1:patient/n1:languageCommunication/n1:languageCode[@code='fra']">
                              <xsl:text>French</xsl:text>
                            </xsl:when>
                            <xsl:when test="n1:patient/n1:languageCommunication/n1:languageCode[@code='ja'] or n1:patient/n1:languageCommunication/n1:languageCode[@code='jpn']">
                              <xsl:text>Japanese</xsl:text>
                            </xsl:when>
                            <xsl:when test="n1:patient/n1:languageCommunication/n1:languageCode[@code='zh'] or n1:patient/n1:languageCommunication/n1:languageCode[@code='zho']">
                              <xsl:text>Chinese</xsl:text>
                            </xsl:when>
                            <xsl:when test="n1:patient/n1:languageCommunication/n1:languageCode[@code='vi'] or n1:patient/n1:languageCommunication/n1:languageCode[@code='vie']">
                              <xsl:text>Vietnamese</xsl:text>
                            </xsl:when>
                            <xsl:when test="n1:patient/n1:languageCommunication/n1:languageCode[@code='ru'] or n1:patient/n1:languageCommunication/n1:languageCode[@code='rus']">
                              <xsl:text>Russian</xsl:text>
                            </xsl:when>
                            <xsl:when test="n1:patient/n1:languageCommunication/n1:languageCode[@code='ar']">
                              <xsl:text>Arabic</xsl:text>
                            </xsl:when>
                            <xsl:when test="n1:patient/n1:languageCommunication/n1:languageCode[@code='fil']">
                              <xsl:text>Filipino</xsl:text>
                            </xsl:when>
                            <xsl:when test="n1:patient/n1:languageCommunication/n1:languageCode[@code='de']">
                              <xsl:text>German</xsl:text>
                            </xsl:when>
                            <xsl:when test="n1:patient/n1:languageCommunication/n1:languageCode[@code='el']">
                              <xsl:text>Greek</xsl:text>
                            </xsl:when>
                            <xsl:when test="n1:patient/n1:languageCommunication/n1:languageCode[@code='hi']">
                              <xsl:text>Hindi</xsl:text>
                            </xsl:when>
                            <xsl:when test="n1:patient/n1:languageCommunication/n1:languageCode[@code='it']">
                              <xsl:text>Italian</xsl:text>
                            </xsl:when>
                            <xsl:when test="n1:patient/n1:languageCommunication/n1:languageCode[@code='ko']">
                              <xsl:text>Korean</xsl:text>
                            </xsl:when>
                            <xsl:when test="n1:patient/n1:languageCommunication/n1:languageCode[@code='pl']">
                              <xsl:text>Polish</xsl:text>
                            </xsl:when>
                            <xsl:when test="n1:patient/n1:languageCommunication/n1:languageCode[@code='pt']">
                              <xsl:text>Portuguese</xsl:text>
                            </xsl:when>
                            <xsl:otherwise>
                              <xsl:apply-templates select="n1:patient/n1:languageCommunication/n1:languageCode" mode="LanguageCommunication"/>
                            </xsl:otherwise>
                          </xsl:choose>
												</td>
											</tr>
...
********************************************************
  ...
  <xsl:template match="n1:addr">
    <xsl:choose>
      ...
      <xsl:otherwise>
        ...
        <xsl:if test="n1:city!=''">
          <nobr>
            <xsl:value-of select="n1:city"/>, <xsl:apply-templates select="n1:state" mode="DisplayGiven"/><xsl:apply-templates select="n1:postalCode" mode="DisplayGiven"/>
          </nobr>
          <br/>
        </xsl:if>
  ...
  <xsl:template match="*" mode="Date">
    <xsl:choose>
      ...
      <xsl:when test="string-length(@value)&gt;11">
        ...
        <xsl:text> </xsl:text>
        <nobr>
          at <xsl:apply-templates select="." mode="TimeDisplay"/> <xsl:if test="substring(@value, 15, 1)='-' or substring(@value, 15, 1)='+'">
  ...
  <xsl:template match="*" mode="TimeDisplay">
    ...
    <xsl:value-of select="$Hours"/>:<xsl:value-of select="substring(@value, 11, 2)"/><xsl:if test="string-length(@value)&gt;5">
      :<xsl:value-of select="substring(@value, 13, 2)"/>
    </xsl:if><xsl:value-of select="$Meridian"/>
  </xsl:template>
          ...
          <xsl:when test="@displayName!=''">
            ...
            <xsl:if test="@code!=''">
              <small>
                <i>
                  <nobr>
                    (<xsl:apply-templates select="@code" mode="DisplayGiven"/><xsl:text> </xsl:text><xsl:value-of select="@codeSystemName"/>)
                  </nobr>
                </i>
              </small>
            </xsl:if>
